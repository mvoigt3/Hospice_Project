	...
	class Astra_Ext_Advanced_Headers_Meta {
		...
		public function menu_highlight() {
			...
			if ( 'astra_adv_header' == $post_type ) :
				...
				$submenu_file = 'edit.php?post_type=astra_adv_header';
		 ...
		 */
		function get_default_header_sections( $header_section ) {
		...
		function save_meta_box( $post_id ) {
			...
			if ( '' != $logo_id ) {
				Astra_Ext_Advanced_Headers_Meta::generate_logo_by_width( $logo_id );
			}
		}
		...
		public function page_header_tab( $options ) {
			...
			<table class="ast-advanced-headers-table design-wrap widefat">
				...
				<tr class="ast-advanced-headers-row">
					...
					<td class="ast-advanced-headers-row-content">
						<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
								...
								value="<?php echo esc_attr( $design['title-color'] ); ?>" placeholder='#000'/>
					</td>
				</tr>
				...
				<tr class="ast-advanced-headers-row breadcrumb-row">
					...
					<td class="ast-advanced-headers-row-content">
						<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
								...
								value="<?php echo esc_attr( $design['b-text-color'] ); ?>" placeholder='#000'/>
					</td>
				</tr>
				<tr class="ast-advanced-headers-row breadcrumb-row">
					<td class="ast-advanced-headers-row-sub-heading">
					...
					<td class="ast-advanced-headers-row-content">
						<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
								...
								value="<?php echo esc_attr( $design['b-link-color'] ); ?>" placeholder='#000'/>
					</td>
				</tr>
				...
				<tr class="ast-advanced-headers-row breadcrumb-row">
					...
					<td class="ast-advanced-headers-row-content">
						<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
								...
								value="<?php echo esc_attr( $design['b-link-hover-color'] ); ?>" placeholder='#000'/>
					</td>
				</tr>
					...
					<td class="ast-advanced-headers-row-content">
						...
						<div class="ast-advanced-haeders-design-bg-custom-size-wrap">
							<input type="text" name="ast-advanced-headers-design[bg-custom-size-top-padding]"
									...
									style="width:110px;"/>
							<label
								for="ast-advanced-haeders-design-bg-custom-size-top-padding"><?php esc_html_e( 'Top Padding', 'astra-addon' ); ?></label>
							<br>
							<input type="text" name="ast-advanced-headers-design[bg-custom-size-bottom-padding]"
				...
				<tr class="ast-advanced-headers-row">
					...
					<td class="ast-advanced-headers-row-content">
						<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true" data-rgba="true"
								...
								value="<?php echo esc_attr( $design['background-color'] ); ?>" placeholder='#000'/>
					</td>
				</tr>
				<tr class="ast-advanced-headers-row">
					<td class="ast-advanced-headers-row-sub-heading">
				...
				<tr class="ast-advanced-headers-row">
					...
					<td class="ast-advanced-headers-row-content">
						<input type="checkbox" name="ast-advanced-headers-design[parallax]"
								value="enabled" <?php checked( isset( $design['parallax'] ) ? $design['parallax'] : '', 'enabled' ); ?> />
					</td>
				</tr>
				</tr>
			</table>
		...
		public function site_header_tab( $options ) {
			...
			<table class="ast-advanced-headers-table require-merge-ast-advanced-header widefat">
				...
				<tr class="ast-advanced-headers-row">
					...
					<td class="ast-advanced-headers-row-content">
						<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
								...
								value="<?php echo esc_attr( $design['header-bg-color'] ); ?>" placeholder='#000'/>
					</td>
				</tr>
					...
					<tr class="ast-advanced-headers-row">
						...
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									...
									value="<?php echo esc_attr( $design['site-title-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
					<tr class="ast-advanced-headers-row">
						<td class="ast-advanced-headers-row-sub-heading">
						...
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									...
									value="<?php echo esc_attr( $design['site-title-h-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
					<?php
				}
					...
					<tr class="ast-advanced-headers-row">
						...
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									...
									value="<?php echo esc_attr( $design['site-tagline-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
					<?php
				}
				...
				<tr class="ast-advanced-headers-row">
					...
					<td class="ast-advanced-headers-row-content">
						<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
							...
							value="<?php echo esc_attr( $design['header-main-sep-color'] ); ?>" placeholder='#000'/>
					</td>
				</tr>
				</table>
				<!-- Primary menu Colors  -->
				<table class="ast-advanced-headers-table widefat">
					...
					<tr class="ast-advanced-headers-row require-merge-ast-advanced-header">
						...
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									...
									value="<?php echo esc_attr( $design['primary-menu-bg-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
					<tr class="ast-advanced-headers-row require-merge-ast-advanced-header">
						<td class="ast-advanced-headers-row-sub-heading">
						...
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									...
									value="<?php echo esc_attr( $design['primary-menu-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
					<tr class="ast-advanced-headers-row require-merge-ast-advanced-header">
						<td class="ast-advanced-headers-row-sub-heading">
							<label><?php esc_html_e( 'Link Active / Hover Color', 'astra-addon' ); ?></label>
						</td>
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									name="ast-advanced-headers-design[primary-menu-h-color]"
									value="<?php echo esc_attr( $design['primary-menu-h-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
					...
					<tr class="ast-advanced-headers-row">
						<td class="ast-advanced-headers-row-sub-heading">
							<label><?php esc_html_e( 'Custom Primary Menu', 'astra-addon' ); ?></label>
						</td>
						<td class="ast-advanced-headers-row-content">
							<?php
					...
					<tr class="ast-advanced-headers-row ast-custom-menu-item-text-enabled">
						...
						<td class="ast-advanced-headers-row-content">
							<textarea type="checkbox" id="ast-advanced-header-custom-menu-item-text-html" name="ast-advanced-headers-design[custom-menu-item-text-html]" ><?php echo isset( $design['custom-menu-item-text-html'] ) ? $design['custom-menu-item-text-html'] : ''; ?></textarea>
						</td>
					</tr>
				</table>
				<?php
					...
					<tr class="ast-advanced-headers-row ast-above-header-required">
						...
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									...
									value="<?php echo esc_attr( $design['above-header-bg-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
					<tr class="ast-advanced-headers-row ast-above-header-required">
						<td class="ast-advanced-headers-row-sub-heading">
						...
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									...
									value="<?php echo esc_attr( $design['above-header-text-link-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
					<tr class="ast-advanced-headers-row ast-above-header-required">
						<td class="ast-advanced-headers-row-sub-heading">
						...
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									...
									value="<?php echo esc_attr( $design['above-header-h-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
				</table>
					<?php
					...
					<tr class="ast-advanced-headers-row ast-below-header-required">
						...
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									...
									value="<?php echo esc_attr( $design['below-header-bg-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
					<tr class="ast-advanced-headers-row ast-below-header-required">
						<td class="ast-advanced-headers-row-sub-heading">
						...
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									...
									value="<?php echo esc_attr( $design['below-header-text-link-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
					<tr class="ast-advanced-headers-row ast-below-header-required">
						<td class="ast-advanced-headers-row-sub-heading">
						...
						<td class="ast-advanced-headers-row-content">
							<input type="text" class="ast-advanced-headers-color-picker" data-alpha="true"
									...
									value="<?php echo esc_attr( $design['below-header-h-color'] ); ?>" placeholder='#000'/>
						</td>
					</tr>
				</table>
					<?php
