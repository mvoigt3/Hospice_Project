...
if ( ! class_exists( 'Astra_Ext_Nav_Menu_Markup' ) ) {
	...
	final class Astra_Ext_Nav_Menu_Markup {
		...
		public function add_custom_fields( $id, $item, $depth, $args ) {
			...
			<input type="hidden" class="ast-nonce-field" value="<?php echo wp_create_nonce( 'ast-render-opts-' . $id ); ?>">

			<p class="description description-wide">
				<a data-depth="<?php echo $depth; ?>" class="button button-secondary button-large astra-megamenu-opts-btn">
					<?php
		...
		function render_mm_popup_html() {
			...
			<div class="astra-mm-title-wrap">
				...
				<span class="ast-editing-label" data-label="<?php _e( 'Editing', 'astra-addon' ); ?>"></span>	
				<div class="astra-mm-close dashicons dashicons-no-alt"></div>
			</div>
			<div class="ast-mm-settings">
				<div class="astra-mm-option-container field-mm-megamenu-opts <?php echo $parent_container_class; ?> " >
					<h2 class="astra-mm-option-heading"><?php _e( 'Mega Menu', 'astra-addon' ); ?></h2>

					<input type="hidden" class="ast-nonce-field" name="ast-mm-opts-nonce-<?php echo $menu_item_id; ?>" value="<?php echo wp_create_nonce( 'ast-save-opts-' . $menu_item_id ); ?>">
					<input type="hidden" class="ast-nonce-field ast-drop-widget-nonce" name="ast-drop-widget-nonce-<?php echo $menu_item_id; ?>" value="<?php echo wp_create_nonce( 'ast-drop-widget-' . $menu_item_id ); ?>">
					<input type="hidden" class="ast-nonce-field ast-render-widgets-nonce" name="ast-render-widgets-nonce-<?php echo $menu_item_id; ?>" value="<?php echo wp_create_nonce( 'ast-render-widgets-' . $menu_item_id ); ?>">
					...
					<div class="astra-mm-settings-wrap field-mm-width" <?php echo $mm_container_style; ?> >
						<div class="ast-mm-label-container">
					...
					<div class="astra-mm-settings-wrap field-mm-enabled-heading <?php echo $parent_container_class; ?> " >
						<div class="ast-mm-label-container">
					...
					<div class="astra-mm-settings-wrap field-mm-header-sep-color <?php echo $color_class; ?>">
						<div class="ast-mm-label-container">
							<label>
								<?php _e( 'Column Heading Separator Color', 'astra-addon' ); ?>
							</label>
						</div>
						<div class="astra-option-input-container">
				...
				<div class="astra-mm-option-container field-mm-megamenu-label" >
					<h2 class="astra-mm-option-heading"><?php _e( 'Menu Label', 'astra-addon' ); ?></h2>
					...
					<div class="astra-mm-settings-wrap field-mm-disable-link" <?php echo $menulabel_style; ?>>
						<div class="ast-mm-label-container">
				...
				<div class="astra-mm-option-container field-mm-bg-img bg-image-container" <?php echo $mm_container_style; ?> >
					<h2 class="astra-mm-option-heading"><?php _e( 'Background Color / Image', 'astra-addon' ); ?></h2>
					<div class="astra-mm-settings-wrap">
						<div class="ast-mm-label-container">
							<label>
								<?php _e( 'Background Color', 'astra-addon' ); ?>
							</label>
						</div>
						<div class="astra-option-input-container">
					...
					<div class="astra-mm-settings-wrap">
						...
						<div class="ast-mm-label-container">
							<label>
								<?php _e( 'Background image', 'astra-addon' ); ?>
							</label>
						</div>
						<?php
						$image_set_cls = '';
						...
						?>
						<div class="astra-option-input-container ast-media-img-container <?php echo $image_set_cls; ?>">
					...
					<div class="astra-mm-settings-wrap">
						<div class="ast-mm-label-container">
							<label>
								<?php _e( 'Background Repeat', 'astra-addon' ); ?>
							</label>
						</div>
						<div class="astra-option-input-container">
							<?php
					...
					<div class="astra-mm-settings-wrap">
						<div class="ast-mm-label-container">
							<label>
								<?php _e( 'Background Size', 'astra-addon' ); ?>
							</label>
						</div>
						<div class="astra-option-input-container">
							<?php
					...
					<div class="astra-mm-settings-wrap field-mm-bg-position">
						...
						<div class="ast-mm-label-container">
							<label>
								<?php _e( 'Background Position', 'astra-addon' ); ?>
							</label>
						</div>
						<div class="astra-option-input-container">
							<?php
				...
				<div class="astra-mm-option-container field-mm-color" <?php echo $mm_container_style; ?> >
					<h2 class="astra-mm-option-heading"><?php _e( 'Override Colors for this mega menu?', 'astra-addon' ); ?></h2>
					<div class="astra-mm-settings-wrap field-mm-text-color">
						<div class="ast-mm-label-container">
							<label>
								<?php _e( 'Text/Link Color', 'astra-addon' ); ?>
							</label>
						</div>
						<div class="astra-option-input-container">
					...
					<div class="astra-mm-settings-wrap field-mm-text-hover-color">
						<div class="ast-mm-label-container">
							<label>
								<?php _e( 'Text/Link Hover Color', 'astra-addon' ); ?>
							</label>
						</div>
						<div class="astra-option-input-container">
					...
					<div class="astra-mm-settings-wrap field-mm-column-div-color">
						<div class="ast-mm-label-container">
							<label>
								<?php _e( 'Column Divider Color', 'astra-addon' ); ?>
							</label>
						</div>
						<div class="astra-option-input-container">
				...
				<div class="astra-mm-option-container field-mm-content-src <?php echo $parent_container_class; ?>" >
					<h2 class="astra-mm-option-heading"><?php _e( 'Content Source', 'astra-addon' ); ?></h2>
					<div class="astra-mm-settings-wrap">
						<div class="ast-mm-label-container">
					...
					<div class="astra-mm-settings-wrap field-mm-custom-text">
						...
						<div class="astra-option-input-container">
							<textarea cols="65" rows="15" class="ast-custom-text-editor" id="menu-item-megamenu_custom_text" name="menu-item-megamenu_custom_text"><?php echo $megamenu_custom_text; ?></textarea>
						</div>
					</div>
					...
					<div class="astra-mm-settings-wrap field-mm-widget-option">
						...
						<div class="astra-option-input-container">
							...
							<select id="edit-menu-item-megamenu_widget-<?php echo esc_attr( $menu_item_id ); ?>" class="form-control ast-input ast-select-widget" name="menu-item-megamenu_widget" / >
								...
								<option value=""><?php _e( 'Select widget', 'astra-addon' ); ?></option>
							...
							<button class="button button-primary ast-insert-widget"><?php _e( 'Add Widget', 'astra-addon' ); ?></button>
						</div>
					</div>
				...
				<div class="astra-mm-option-container field-mm-highlight-label" >
					<h2 class="astra-mm-option-heading"><?php _e( 'Highlight Labels', 'astra-addon' ); ?></h2>
					<div class="astra-mm-settings-wrap">
						<div class="ast-mm-label-container">
					...
					<div class="astra-mm-settings-wrap">
						<div class="ast-mm-label-container">
							<label>
								<?php _e( 'Highlight Label Color', 'astra-addon' ); ?>
							</label>
						</div>
						<div class="astra-option-input-container">
					...
					<div class="astra-mm-settings-wrap">
						<div class="ast-mm-label-container">
							<label>
								<?php _e( 'Highlight Label Background Color', 'astra-addon' ); ?>
							</label>
						</div>
						<div class="astra-option-input-container">
			...
			<div class="astra-mm-cta-wrap">
				<div class="alignright">
					...
					<a data-label="<?php _e( 'Save', 'astra-addon' ); ?>" class="button button-primary button-large astra-megamenu-save-opts"><?php _e( 'Save', 'astra-addon' ); ?></a>
					<a class="button button-primary button-large astra-megamenu-cancel-btn">		<?php _e( 'Cancel', 'astra-addon' ); ?>
					</a>
				</div>
			</div>
			<?php
