	...
	class Addon_Gutenberg_Editor_CSS {
		...
		public function colors_and_background_addon_gutenberg_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
			...
			$colors_and_background_output = array(
				 ...
				 */
				'.edit-post-visual-editor h1, .wp-block-heading h1.editor-rich-text__tinymce, .editor-post-title__block .editor-post-title__input' => array(
			...
			if ( in_array( $pagenow, array( 'post-new.php' ) ) || 'content-boxed-container' === $container_layout || 'boxed-container' === $container_layout ) {
				...
				$boxed_container = array(
					'.editor-writing-flow, 
					.ast-separate-container .editor-writing-flow' => astra_get_background_obj( $content_bg_obj ),
		...
		public function spacing_addon_gutenberg_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
			...
			if ( 'content-boxed-container' === $container_layout || 'boxed-container' === $container_layout ) {
				...
				$boxed_container = array(
					...
					'.editor-writing-flow .editor-block-list__layout' => array(
						'padding-top' => '0',
					),
					...
					'.editor-block-list__layout .editor-block-list__block[data-align="full"] > .editor-block-list__block-edit' => array(
				...
				if ( '' !== astra_responsive_spacing( $continer_inside_spacing, 'left', 'desktop' ) ) {
					$boxed_container['.edit-post-visual-editor .editor-block-list__block .editor-block-list__block-edit, .editor-post-title__block .editor-post-title__input'] = array(
						'padding-left'  => 0,
						'padding-right' => 0,
					);
				}
